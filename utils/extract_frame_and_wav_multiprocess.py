...
input_path = '/root/data1/ltp/datasets/vision-language/webvid/webvid_all_videos'
output_path = '/root/data1/ltp/datasets/vision-language/webvid/webvid_all_videos_process'
